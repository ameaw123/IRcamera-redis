...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qRedis_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qRedis_t qt_meta_stringdata_qRedis = {
    {
QT_MOC_LITERAL(0, 0, 6), // "qRedis"
QT_MOC_LITERAL(1, 7, 9), // "connected"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 12), // "disconnected"
QT_MOC_LITERAL(4, 31, 10), // "returnData"
QT_MOC_LITERAL(5, 42, 13), // "qRedis::Reply"
QT_MOC_LITERAL(6, 56, 11), // "connectHost"
QT_MOC_LITERAL(7, 68, 4), // "host"
QT_MOC_LITERAL(8, 73, 4), // "port"
QT_MOC_LITERAL(9, 78, 14), // "disconnectHost"
QT_MOC_LITERAL(10, 93, 13), // "slotConnected"
QT_MOC_LITERAL(11, 107, 16), // "slotDisconnected"
QT_MOC_LITERAL(12, 124, 8) // "response"
...
void qRedis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&qRedis::connected)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (qRedis::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&qRedis::disconnected)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&qRedis::returnData)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject qRedis::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qRedis.data,
      qt_meta_data_qRedis,  qt_static_metacall, nullptr, nullptr}
};
...
void *qRedis::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qRedis.stringdata0))
