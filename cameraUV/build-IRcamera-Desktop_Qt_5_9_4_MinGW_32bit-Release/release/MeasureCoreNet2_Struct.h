...
typedef int(*LIVEVIDEOSTREAMSTATERECV_CB)(const int state);
typedef int(*LIVEVIDEOMEASURESTATERECV_CB)(const int state);
typedef int(*H264STREAMRECV_CB)(const LiveStream_H264StreamCallBack * pInfo);
typedef int(*LIVEVIDEOSTREAMRGBRECV_CB)(const LiveStream_LiveVideoStreamRGBCallBack * pInfo);
